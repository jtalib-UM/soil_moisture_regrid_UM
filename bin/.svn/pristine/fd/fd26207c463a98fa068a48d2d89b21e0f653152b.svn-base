...
def fill_ostia_lakes(cci_cube, ostia_flag):
    ...
    lakes = [
        ...
        # ?            "savern",
        # ?            (38.66, 42.98),
        # ?        ),  # area_min:3740.00km2; area_poly:3537.90km2; We are actually asking for lake "van" but it's geometry is associated with "savern" under Natural Earth...
        ...
        #        ("buenos aires", (-46.66, -72.50)),  # area_min:2240.00km2; area_poly:1848.20km2
        ...
        #            (50.44, 68.90),
        #            False,
        #        ),  # area_min:1590.00km2; area_poly:1382.60km2; tengiz fetches the SELETYTENIZ lake geometry so we force a non match.
        ...
        #        ("boeng tonle chhma", (12.81, 104.15)),  # area_min:--km2; area_poly:2569.90km2
...
def main(source_filepath, igbp_filepath, output_filepath, nemo_flag, ostia_flag):
    """
...
def _get_parser():
    ...
    parser.add_argument(
        "--nemo-flag",
        type=str,
        help='Flag to assign for NEMO lakes (defaults to "sea_ocean_water").',
        default="sea_ocean_water",
    )
    parser.add_argument(
        "--ostia-flag",
        type=str,
        help='Flag to assign for OSTIA lakes (defaults to "resolved_lake").',
...
if __name__ == "__main__":
    ...
    main(args.sources, args.igbp_source, args.output, args.nemo_flag, args.ostia_flag)
