...
def main(
    ...
    ants.save(
        land_mask, os.path.join(output_filepath, "qrparm.mask"), fill_value=-1,
    )
    ants.save(
        sea_mask, os.path.join(output_filepath, "qrparm.mask_sea"), fill_value=-1,
    )
    ants.save(land_fraction, os.path.join(output_filepath, "qrparm.landfrac"))
